     ...
     <h1>Image Upload:</h1>
       ...
       <form method="post" enctype="multipart/form-data">
        <div class="form-group">
         ...
         if($fileType =='image/jpeg' || $fileType=='image/png' || $fileType =='image/gif' || $fileType=='image/jpg' || $sfileType =='image/jpeg' || $sfileType=='image/png' || $sfileType =='image/gif' || $sfileType=='image/jpg'){
          ...
          ?>
           ...
           echo "<div class='alert alert-danger'> IMAGE is too large to Upload</div>";
            echo "<div class='alert alert-danger'> SIGNATURE is too large to Upload</div>";
             ...
             echo "<div class='alert alert-danger'>Only IMAGEfiles are acceptable..</div>";
