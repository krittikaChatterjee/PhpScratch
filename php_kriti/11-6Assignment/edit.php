     ...
     ?>
	   ...
	   <div class="container">
	   	...
	   	<div class="form-group">
	   		...
	   		<input type="text" name="t11" required value="<?php echo $data['proname'];?>" class="form-control">
	   	</div>
	   	<div class="form-group">
	   		<label>Quantity :</label>
	   		<input type="number" name="t22" required value="<?php echo $data['quantity']; ?>" class="form-control">
	   	</div>
	   	<div class="form-group">
	   		<label>Price :</label>
