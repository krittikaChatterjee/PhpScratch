...
<?php include"asset/nabbar.php" ?>
     ...
     <div class="container border">
           ...
           <header class="bg-success text-green"><font color="black"><h1 align="center">Sign up</h1></font></header>
         <form action="order.php" method="post"  autocomplete="off">  
             ...
             <div class="form-group">
                 ...
                 <button name="btnSubmit" value="submit" id="b2" class="btn btn-sm btn-success">Register</button>
             </div>
